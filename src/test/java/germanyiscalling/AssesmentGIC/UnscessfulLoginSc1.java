...
public class UnscessfulLoginSc1 {
	// this
	@Test
	public void invalidemailvalidps() {
		...
		if(EmptyMsg.equals("Please enter a correct username and password. Note that both fields may be case-sensitive.")) {
